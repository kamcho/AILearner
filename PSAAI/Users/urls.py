...
from . import views
from .views import RegisterView, MyProfile, Home, loginRedirect,LoginRedirect, FinishSetup
...
urlpatterns = [
    ...
    path('redirect/', LoginRedirect.as_view(), name='redirect'),
    path('Set-Up/', FinishSetup.as_view(), name='edit-profile'),
