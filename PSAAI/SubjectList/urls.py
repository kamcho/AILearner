...
from SubjectList.views import Learning, Read, Assignment, Finish, AssignmentDetail, Syllabus, Messages, MyProgress, \
    ContactUs

urlpatterns = [

    path('Grade-<str:grade>/Subjects/', Learning.as_view(), name='learn'),
    path('E-Learning/<str:topic> /<str:subtopic>/Study', Read.as_view(), name='read'),
